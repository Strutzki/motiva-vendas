...
self.addEventListener("activate", (e) => {
  e.waitUntil(
    caches.keys().then((keys) =>
      ...
      /* Ao ativar uma NOVA versão, recarrega os apps já abertos pra saírem
         do código antigo em memória (conserta PWA preso na tela de ontem). */
